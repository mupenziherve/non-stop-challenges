  ...
  return (
    ...
    >
      ...
      <div className="fixed top-6 right-6 z-50 flex flex-col gap-3">
        {status === 'success' && (
          <div className="flex items-center gap-3 px-5 py-3 rounded-xl bg-green-500/10 border border-green-500/20 backdrop-blur-xl shadow-2xl">
        ...
        {status === 'error' && (
          <div className="flex items-center gap-3 px-5 py-3 rounded-xl bg-red-500/10 border border-red-500/20 backdrop-blur-xl shadow-2xl">
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-black via-gray-900 to-black" />
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex gap-6 mt-6">
          <Link href="https://github.com/mupenziherve" target="_blank">
            <div className="p-3 rounded-xl bg-white/5 hover:bg-white/10 transition border border-white/10">
              <Image
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-linear-to-r from-blue-500 via-cyan-500 to-teal-500 text-white font-semibold hover:opacity-90 transition disabled:opacity-50"
          >
